                ...
                <div class="card shadow p-2 mb-5 bg-body">
                    ...
                    <div class="card-header text-center text-light bg-primary p-3 m-2"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h6 class="mt-2">لیست دسته بندی های خرجکرد</h6>
                    ...
                    <div class="card-body">
                        @if (blank($categories))
                            <div class="d-grid gap-2 mt-2">
                                ...
                                <a href="{{ route('users.categories.costs.create') }}"
                                    class="btn btn-success"
                                    style="border-radius: 15px;">
                                    ثبت اطلاعات دسته بندی خرجکرد
                                </a>
                            </div>
                        @else
                            <div class="d-grid gap-2 m-2">
                                <a class="btn btn-success" href="{{ route('users.categories.costs.create') }}"
                                    style="border-radius: 15px;">
                            ...
                            <table class="table table-bordered table-striped text-center">
                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr>
                                            <th>
                                                <a href="{{ route('users.categories.costs.edit', $category->id) }}">
                                                    {{ $category->title }}
                                                </a>
                                            </th>
                                            <th>
                                            ...
                                            <th>
                                                <a href="{{ route('users.categories.costs.delete', $category->id) }}"
                                                    {{-- style="border-radius: 15px;"
